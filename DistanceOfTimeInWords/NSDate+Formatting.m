...
+ (NSString *)rangeOfTimeInWordsFromSeconds:(NSInteger)seconds {
    ...
    int months    = (int)round(seconds / SECONDS_PER_MONTH);
    ...
    return [NSString stringWithFormat:@"%@%d %@", modifier, number, measure];
}
